...
*/
var xb64={encode:function(a,d){if(null==a)return null;d=xb64.UTF8.toByteArray(d);var c=a.length,b=d.length;if(0==c||0==b)var e=a;else{var f=b-c;0>f&&(f=0);e=[];for(var g=0;g<c;g++)e.push(a[g]^d[g%b]);for(g=0;g<f;g++)e.push(255^d[(c+g)%b]);e.push(f)}return xb64.Base64.encode(e)},encodeFromString:function(a,d){if(null==a)return null;a=xb64.UTF8.toByteArray(a);return xb64.encode(a,d)},decode:function(a,d){if(null==a)return null;a=xb64.Base64.decode(a);d=xb64.UTF8.toByteArray(d);var c=a.length,b=d.length;
if(0==c||0==b)return a.slice();c=c-a[c-1]-1;for(var e=[],f=0;f<c;f++)e.push(a[f]^d[f%b]);return e},decodeToString:function(a,d){if(null==a)return null;a=xb64.decode(a,d);return xb64.UTF8.fromByteArray(a)},Base64:{encode:function(a){var d=a.length;if(0==d)return"";for(var c={64:61,63:47,62:43},b=0;62>b;b++)c[b]=26>b?b+65:52>b?b+71:b-4;var e="";for(b=0;b<d;b+=3)e+=String.fromCharCode(c[a[b]>>>2],c[(a[b]&3)<<4|a[b+1]>>>4],c[b+1<d?(a[b+1]&15)<<2|a[b+2]>>>6:64],c[b+2<d?a[b+2]&63:64]);return e},decode:function(a){var d=
